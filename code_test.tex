...
%\begin{inlinecode}[noattach=false,label={lst:inline_code},
%caption={Príklad krátkeho zdrojového kódu.}]{python}
%def  powerpowerpowerpowerpowerpowerpower(x):
%	return x ** 2
%\end{inlinecode}
%
%
...
%\inputcode[noattach=false,breaklines=True,firstline=5,lastline=38]{python}{listings/delta_rule.py}
...
%\stepcounter{TFFile}
%\def\TFFname{\jobname-code-\theTFFile.py}
%\begin{VerbatimOut}{\TFFname}
%def power(x):
%    return x ** 2
%\end{VerbatimOut}
%\begin{code}
%\inputcode{python}{\mintedoutputdir/\TFFname}
%\end{code}
%
%
%
...
%\end{VerbatimOut}
%\begin{code}
%\inputcode[noattach=False]{python}{\mintedoutputdir/\TFFname}
%\end{code}
